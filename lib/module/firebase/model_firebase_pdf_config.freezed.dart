...
abstract class $MinorCategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String mainorKey, String minorTitle, String minorSummary, Map<String, DetailCategory> details});
}
...
class _$MinorCategoryImpl implements _MinorCategory {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.mainorKey, mainorKey) || other.mainorKey == mainorKey) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, mainorKey, minorTitle, minorSummary, const DeepCollectionEquality().hash(_details));
...
abstract class $SettionCopyWith<$Res> {
  ...
  @useResult
  $Res call({String settionTitle, String pdfId, String searchWord, String markdown});
}
...
class _$SettionImpl implements _Settion {
  _$SettionImpl({this.settionTitle = '', this.pdfId = '', this.searchWord = '', this.markdown = ''});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, settionTitle, pdfId, searchWord, markdown);
...
abstract class _Settion implements Settion {
  factory _Settion({final String settionTitle, final String pdfId, final String searchWord, final String markdown}) =
      _$SettionImpl;
