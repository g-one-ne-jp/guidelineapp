...
rm -rf ./archive/Runner-P-${VERSION_NAME}-${VERSION_CODE_PROFILE}.xcarchive
mv ./build/ios/archive/Runner.xcarchive ./archive/Runner-P-${VERSION_NAME}-${VERSION_CODE_PROFILE}.xcarchive
rm -f ./archive/Runner-P-${VERSION_NAME}-${VERSION_CODE_PROFILE}.ipa
mv ./build/ios/ipa/JCSGuidelines.ipa ./archive/Runner-P-${VERSION_NAME}-${VERSION_CODE_PROFILE}.ipa
